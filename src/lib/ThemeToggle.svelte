...
<div class="relative inline-block text-sm">
	...
	<button
		...
		aria-haspopup="menu"
		aria-expanded={open}
		class="inline-flex items-center gap-2 rounded-md border border-neutral-300 bg-neutral-100
           px-3 py-1.5 transition select-none
           hover:bg-neutral-200 dark:border-neutral-700 dark:bg-neutral-800 dark:hover:bg-neutral-700"
	>
	...
	{#if open}
		...
		<div
			...
			class="absolute right-0 z-50 mt-2 w-40 overflow-hidden rounded-lg border
             border-neutral-200 bg-white shadow-lg dark:border-neutral-700 dark:bg-neutral-800"
		>
			<button
				role="menuitem"
